...
int relSlater::getNumOfDets() const {return determinants.size();}
...
void relSlater::getVariables(Eigen::VectorBlock<VectorXd> &v) const
{ 
  int norbs = relDeterminant::norbs;  
...
long relSlater::getNumVariables() const
{
  long numVars = 0;
...
void relSlater::printVariables() const
{
