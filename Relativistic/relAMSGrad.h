...
*/
#ifndef relOPTIMIZER_HEADER_H
#define relOPTIMIZER_HEADER_H
#include <Eigen/Dense>
...
class relAMSGrad
{
  ...
  public:
    ...
    relAMSGrad(double pstepsize=0.001, double pdecay_mom1=0.1, double pdecay_mom2=0.001, int pmaxIter=1000, int pavgIter=0) : stepsize(pstepsize), decay_mom1(pdecay_mom1), decay_mom2(pdecay_mom2), maxIter(pmaxIter), avgIter(pavgIter)
    {
        iter = 0;
    }

    relAMSGrad(std::vector<double> pstepsizes, double pdecay_mom1=0.1, double pdecay_mom2=0.001, int pmaxIter=1000, int pavgIter=0) : stepsizes(pstepsizes), decay_mom1(pdecay_mom1), decay_mom2(pdecay_mom2), maxIter(pmaxIter), avgIter(pavgIter)
    {
        iter = 0;
    }
