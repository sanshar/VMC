...
*/
#ifndef relSMW_HEADER_H
#define relSMW_HEADER_H
 ...
 * of the incoming matrix. 
 */
void relCalculateInverseDeterminantWithRowChange(const Eigen::MatrixXcd &inverseIn, const std::complex<double> &detValueIn, const Eigen::MatrixXcd &tableIn,
                                                               Eigen::MatrixXcd &inverseOut, std::complex<double> &detValueOut, Eigen::MatrixXcd &tableOut,
                                                               std::vector<int>& cre, std::vector<int>& des,
