...
template
void BuildJastrowVars(const Eigen::Matrix<Complex<double>, Eigen::Dynamic, 1> &vars, const Determinant &D, Eigen::Matrix<Complex<double>, Eigen::Dynamic, Eigen::Dynamic> &J, Eigen::Matrix<Complex<double>, Eigen::Dynamic, 1> &Jmid, int &numVars);
template
...
template
void BuildOrbitalVars(const Eigen::Matrix<Complex<double>, Eigen::Dynamic, 1> &vars, const Determinant &D, std::array<Complex<double>, 2> &thetaDet, std::array<Eigen::Matrix<Complex<double>, Eigen::Dynamic, Eigen::Dynamic>, 2> &R, int &numVars);
template
...
T JastrowSlaterLocalEnergy(const Determinant &D, const workingArray &work, const Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic> &J, const Eigen::Matrix<T, Eigen::Dynamic, 1> &Jmid, const std::array<Complex<T>, 2> &thetaDet, const std::array<Eigen::Matrix<Complex<T>, Eigen::Dynamic, Eigen::Dynamic>, 2> &R)
{
    ...
    for (int l = 0; l < work.nExcitations; l++)
    {
        ...
        std::complex<double> tia = work.HijElement[l];
